...
import { companyDeductionsApiSlice } from '../api/companyDeductionsApiSlice'
import { orderGuidesApiSlice } from '../api/orderGuidesApiSlice'
...
export default configureStore({
  reducer: {
    ...
    companyDeductionsApi: companyDeductionsApiSlice.reducer,
    orderGuidesApiSlice: orderGuidesApiSlice.reducer,
  },
  middleware: getDefaultMiddleware =>
    getDefaultMiddleware({
      ...
      .concat(companyDeductionsApiSlice.middleware)
      .concat(orderGuidesApiSlice.middleware)
})
